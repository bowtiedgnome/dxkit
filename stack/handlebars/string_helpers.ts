import * as inflections from "https://deno.land/x/quasar@0.0.3/text/inflections.ts";
import { trimEnd, trimStart, trim, isNullOrEmpty, isNullOrWhiteSpace } from "https://deno.land/x/quasar@0.0.3/text/str.ts";
